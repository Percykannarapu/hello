import { ImpProjectPayload } from '../payloads/imp-project-payload';
...
export class ImpProjectState extends BaseModelState {
  ...
  public createDate:                Date = new Date(); /// Date/Time row was created
  public modifyUser:                number;            /// User to modify the row
  public modifyDate:                Date = new Date(); /// Date/Time row was modified
  ...
  constructor(data?: Partial<ImpProjectPayload>) {
    ...
    if (data != null) {
      const additions = {
        ...
        ihwFrom: data.ihwFrom == null ? null : new Date(data.ihwFrom),
        ihwTo: data.ihwTo == null ? null : new Date(data.ihwTo),
        ihd: data.ihd == null ? null : new Date(data.ihd),
        preferredIhDate: data.preferredIhDate == null ? null : new Date(data.preferredIhDate),
