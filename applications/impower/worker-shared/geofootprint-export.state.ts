import { ColumnDefinition, ExportState, WorkerProcessReturnType } from './core-interfaces';
...
import { isEmpty, isNil, prepareOutput, toNullOrNumber } from './export-helpers';
import { GeoFootprintExportFormats, GeoFootprintExportWorkerPayload } from './payload-interfaces';

export const exportGeoFootprint = (payload: GeoFootprintExportWorkerPayload) => {
  const state = new GeoFootprintExportState(payload);
  return prepareOutput(state, WorkerProcessReturnType.BlobUrl);
};
