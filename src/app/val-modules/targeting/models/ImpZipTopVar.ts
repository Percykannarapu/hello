/** A TARGETING domain class representing the table: IMPOWER.IMP_ZIP_TOP_VARS
 **
 ** Generated from VAL_ENTITY_GEN - v2.01
 **/

export class ImpZipTopVar
{
   ...
   public nov:                        string;
   public dec:                        string;
   public janNextYear:                string;
   public febNextYear:                string;
   public marNextYear:                string;
   public aprNextYear:                string;
   public mayNextYear:                string;
   public junNextYear:                string;
   public julNextYear:                string;
   public augNextYear:                string;
   public sepNextYear:                string;
   public octNextYear:                string;
   public novNextYear:                string;
   public decNextYear:                string;
   public zip:                        string;
   public covDesc:                    string;
   public covFrequency:               string;
   public covDelivery:                string;
   public deliveryMethodPrimary:      string;
   public deliveryMethodSecondary:    string;
   public solo:                       number;
   public soloW:                      number;
   public smc:                        number;
   public smcW:                       number;
   ...
   public wrap:                       string;
   public labl:                       string;
   public wrapSecondary:              string;
   public pricingMkt:                 string;
   public pricingMktId:               number;
   public atz:                        string;
   public pob:                        string;
   public prodOrg:                    string;
   public hhld:                       number;
   public hhldW:                      number;
   public nielsenInd:                 string;
   public altDelInd:                  string;
   public secondIhd:                  string;
   public newsCount:                  number;
   public pcdCount:                   number;
   public citySimplifiedInd:          string;
   public cityName:                   string;
   public invOrgNameSecondary:        string;
   public iomCodePrimary:             string;
   public iomCodeSecondary:           string;
   public mailCountSummer:            number;
   public mailCountWinter:            number;
   public newsMailCount:              number;
   public ihdayPrimary:               string;
   public ihdaySecondary:             string;
   public deliveryProviderPrimary:    string;
   public deliveryProviderSecondary:  string;
   public ownerGroupPrimary:          string;
   public ownerNamePrimary:           string;
   public ownerGroupSecondary:        string;
   public ownerNameSecondary:         string;
   public labelSecondary:             string;
   public frequencyCntPrimary:        number;
   public frequencyCntSecondary:      number;
   public ihweekRemaining:            number;
   public exclusivityIndPrimary:      string;
   public secondIhday:                string;
   public numDirectParent:            number;
   public flexibleIndPrimary:         number;
   public flexibleIndSecondary:       number;
   ...
   public lablName:                   string;
   public pricingName:                string;
   public iomName:                    string;
   public wrapSecondaryName:          string;
   public lablSecondaryName:          string;
   public iomSecondaryName:           string;
   public wrapMktId:                  number;
   public mccMktId:                   number;
   public infoscanCode:               string;
   public scantrackCode:              string;
   public owgmInd:                    string;
   public wrapMktIdSecondary:         number;
   public iomCodeIdPrimary:           number;
   public iomCodeIdSecondary:         number;
   public vdpInd:                     string;
   public atzind:                     string;
   public vdpCovDesc:                 string;
   public vdpCovFrequency:            string;
   public vdpCovDelivery:             string;
   public vdpOwnerGroup:              string;
   public vdp:                        number;
   public vdpW:                       number;
   public wrapLink:                   string;
   public wrapSecLink:                string;
   ...
   constructor(data?:Partial<ImpZipTopVar>) {
   ...
   public static getFields () : Map<string, string>
   {
      return new Map([
         ...
         ['covFrequency',                'string'],
         ['covDelivery',                 'string'],
         ['deliveryMethodPrimary',       'string'],
         ['deliveryMethodSecondary',     'string'],
         ['solo',                        'number'],
         ['soloW',                       'number'],
         ['smc',                         'number'],
         ['smcW',                        'number'],
         ...
         ['newsCount',                   'number'],
         ['pcdCount',                    'number'],
         ['citySimplifiedInd',           'string'],
         ['cityName',                    'string'],
         ['invOrgNameSecondary',         'string'],
         ['iomCodePrimary',              'string'],
         ['iomCodeSecondary',            'string'],
         ['mailCountSummer',             'number'],
         ['mailCountWinter',             'number'],
         ['newsMailCount',               'number'],
         ['ihdayPrimary',                'string'],
         ['ihdaySecondary',              'string'],
         ['deliveryProviderPrimary',     'string'],
         ['deliveryProviderSecondary',   'string'],
         ['ownerGroupPrimary',           'string'],
         ['ownerNamePrimary',            'string'],
         ['ownerGroupSecondary',         'string'],
         ['ownerNameSecondary',          'string'],
         ['labelSecondary',              'string'],
         ['frequencyCntPrimary',         'number'],
         ['frequencyCntSecondary',       'number'],
         ['ihweekRemaining',             'number'],
         ['exclusivityIndPrimary',       'string'],
         ['secondIhday',                 'string'],
         ['numDirectParent',             'number'],
         ['flexibleIndPrimary',          'number'],
         ['flexibleIndSecondary',        'number'],
         ['pobScount',                   'number'],
         ['pobWcount',                   'number'],
         ['effectiveDate',               'Date'],
         ['creationDate',                'Date'],
         ...
         ['pricingName',                 'string'],
         ['iomName',                     'string'],
         ['wrapSecondaryName',           'string'],
         ['lablSecondaryName',           'string'],
         ['iomSecondaryName',            'string'],
         ['wrapMktId',                   'number'],
         ['mccMktId',                    'number'],
         ['infoscanCode',                'string'],
         ...
         ['iomCodeIdPrimary',            'number'],
         ['iomCodeIdSecondary',          'number'],
         ['vdpInd',                      'string'],
         ['atzind',                      'string'],
         ['vdpCovDesc',                  'string'],
         ['vdpCovFrequency',             'string'],
         ['vdpCovDelivery',              'string'],
         ['vdpOwnerGroup',               'string'],
         ['vdp',                         'number'],
         ['vdpW',                        'number'],
         ['wrapLink',                    'string'],
         ['wrapSecLink',                 'string'],
