...
export class TargetAudienceMetricService {
  ...
  */
  private calculateMetrics(geoAttributes: ImpGeofootprintGeoAttrib[], geos: ImpGeofootprintGeo[]) {
    ...
    const hhIncome = null; //this.calculateSingleMetric(geoAttributes, 'cl2i00', 0, geos);
    const popFamilies = null; //this.calculateSingleMetric(geoAttributes, 'cl0c00', 2, geos);
    const popHispanic = null; //this.calculateSingleMetric(geoAttributes, 'cl2prh', 2, geos);
    const casualDining = null; // this.calculateSingleMetric(geoAttributes, 'tap049', 0, geos);
